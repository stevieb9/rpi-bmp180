...
MODULE = RPi::BMP180  PACKAGE = RPi::BMP180

PROTOTYPES: DISABLE


int
bmp180_set_addr (_bmp)
	void *	_bmp
...
void *
bmp180_init (address, i2c_device_filepath)
	int	address
...
float
bmp180_temperature (_bmp)
	void *	_bmp

long
bmp180_pressure (_bmp)
	void *	_bmp

float
bmp180_altitude (_bmp)
	void *	_bmp

void
bmp180_set_oss (_bmp, oss)
	void *	_bmp
	int	oss
        PREINIT:
        I32* temp;
